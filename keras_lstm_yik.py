...
print(model.summary())
checkpointer = ModelCheckpoint(filepath=data_path + '/bpi2012_{epoch:02d}_' + str(batch_size) + 'predict_overtime_v3' + '.hdf5', verbose=1)
...
if args.run_opt == 1:
    ...
    for i in range(epoch_num):
        print("load model")
        model = load_model("bpi2012_0" + str(i+1) + "_" + str(batch_size) + "predict_left_timev2.hdf5")
